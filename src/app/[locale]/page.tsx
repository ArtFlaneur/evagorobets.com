...
const content = {
  en: {
    ...
    aboutLabel: "About",
    aboutH2: ["Photographer working between", "Tokyo and Melbourne"],
    aboutBody: "Australian photographer based in Tokyo, with regular working periods in Melbourne and a deep connection to the art world. Available in English, Japanese and Russian.",
    aboutLink: "About Eva",
  ...
  jp: {
    ...
    aboutLabel: "プロフィール",
    aboutH2: ["東京とメルボルンを拠点に活動する", "フォトグラファー"],
    aboutBody: "東京を拠点に、メルボルンでも定期的に活動するオーストラリア人フォトグラファー。アートの世界に深い造詣を持ち、英語・日本語・ロシア語で対応可能。",
    aboutLink: "エヴァについて",
    workingLabel: "活動地域",
    workingList: [
